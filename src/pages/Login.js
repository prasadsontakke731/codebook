...
export const Login = () => {
    ...
    async function handleLogin(event) {
        ...
        try {
            ...
            await data.accessToken ? navigate("/products") : toast.error(data);
        } catch (error) {
